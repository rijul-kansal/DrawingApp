...
class DrawingView(context: Context,attrs:AttributeSet): View(context,attrs) {
    ...
    // used to hold all the paths
    private var mPath=ArrayList<CustomPath>()
    // used to hold all deleted paths
   ...
   // helps in adjusting bit map accordint to screen size
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // in order to persist on screen we use this
